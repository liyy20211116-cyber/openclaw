...
$hasNode = Test-CommandAvailable -Name "node" -Hint "请先安装 Node.js >= 22: https://nodejs.org/"
[void](Test-CommandAvailable -Name "npm" -Hint "npm 通常随 Node.js 一起安装。")
$hasOpenclaw = Test-CommandAvailable -Name "openclaw" -Hint "请执行: npm install -g openclaw@latest"
